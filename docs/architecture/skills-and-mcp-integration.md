...
- Current codebase đã có skill/MCP registries, policy selection, audit logging và runtime wiring path tương ứng với trạng thái hoàn tất hiện tại.
- Tài liệu này nên được đọc như policy source of truth cho behavior hiện tại và hướng mở rộng tiếp theo, không còn là mô tả của một target wiring chưa hoàn tất.
