...
import (
	...
	"github.com/duypham93/dh/packages/opencode-core/internal/tui/components/chat"
	"github.com/duypham93/dh/packages/opencode-core/internal/tui/components/core"
	"github.com/duypham93/dh/packages/opencode-core/internal/tui/components/dialog"
	"github.com/duypham93/dh/packages/opencode-core/internal/tui/layout"
	"github.com/duypham93/dh/packages/opencode-core/internal/tui/page"
	"github.com/duypham93/dh/packages/opencode-core/internal/tui/theme"
	"github.com/duypham93/dh/packages/opencode-core/internal/tui/util"
)
...
func New(app *app.App) tea.Model {
	...
	model.RegisterCommand(dialog.Command{
		...
		Description: "Create/Update the dh.md memory file",
		Handler: func(cmd dialog.Command) tea.Cmd {
			prompt := `Please analyze this codebase and create a dh.md file containing:
1. Build/lint/test commands - especially for running a single test
2. Code style guidelines including imports, formatting, types, naming conventions, error handling, etc.

The file you create will be given to agentic coding agents (such as yourself) that operate in this repository. Make it about 20 lines long.
If there's already a dh.md, improve it.
